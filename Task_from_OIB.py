...
class Finding_threats:
    def __init__(self):
        ...
        self.mas = []    # Массив для "потока"
        self.count = 0    # Счетчик угроз
    ...
    def create_display_frame(self):
        ...
        frame.pack(expand=True, fill='both')    # Растянется на всю возможную ширину 
        return frame
...
# Позволяет запустить класс как отдельную програмку 
